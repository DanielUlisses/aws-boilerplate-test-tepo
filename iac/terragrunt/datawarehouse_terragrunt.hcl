...
locals {
  platform          = yamldecode(file("datawarehouse/aws.yaml"))
  env               = yamldecode(file("datawarehouse/env.yaml"))
  conf              = yamldecode(file("datawarehouse/terragrunt_conf.yaml"))
  region            = yamldecode(file("datawarehouse/reg-primary/region.yaml"))
}
